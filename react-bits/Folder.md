...
1. Copy `Folder.jsx` and `Folder.css` into `src/components/`
2. Import and use with the usage example above
3. Suggested placement: About section — a clickable folder containing CV, portfolio link, and contact info as the three paper items
4. Suggested props for dark site theme:
   - `color="#7c3aed"` (purple accent)
   - `size={1.5}`
   - Pass 3 items as paper content: CV download link, portfolio link, contact
