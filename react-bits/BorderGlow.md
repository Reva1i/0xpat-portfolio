...
## Component Source (BorderGlow.jsx)
...
1. Copy `BorderGlow.jsx` and `BorderGlow.css` into `src/components/`
2. Import and wrap target cards with `<BorderGlow>` using the usage example above
3. Recommended targets: Partnerships cards, Launchpad Titan Launch card, Farms callout cards
